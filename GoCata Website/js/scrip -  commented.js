...
// Having done some research, i found that in terms of allowing this parallax scoll to work for mobiles, the broswer must support webkit and the js may need a different configuration due to it requiring a touch scrolling library. 
...
$(document).ready(
 ...
 // hex colour and changing the size of the cursor border by pixels
  function() { 
...
// Closing the script with sets of appropriate brackets
